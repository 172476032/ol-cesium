...
var Manager = function (_olObservable) {
  _inherits(Manager, _olObservable);
  ...
  Manager.prototype.onCesiumLoaded = function onCesiumLoaded() {
  ...
  Manager.prototype.instantiateOLCesium = function instantiateOLCesium() {
  ...
  Manager.prototype.configureForPerformance = function configureForPerformance(scene) {
    var fog = scene.fog;
    fog.enabled = true;
  ...
  Manager.prototype.configureForUsability = function configureForUsability(scene) {
  ...
  Manager.prototype.limitCameraToBoundingSphere = function limitCameraToBoundingSphere() {
    var _this3 = this;
  ...
  Manager.prototype.toggle3d = function toggle3d() {
    var _this4 = this;
  ...
  Manager.prototype.set3dWithView = function set3dWithView(lon, lat, elevation, headingDeg, pitchDeg) {
    var _this5 = this;
  ...
  Manager.prototype.is3dEnabled = function is3dEnabled() {
  ...
  Manager.prototype.getHeading = function getHeading() {
  ...
  Manager.prototype.getTiltOnGlobe = function getTiltOnGlobe() {
    var scene = this.ol3d.getCesiumScene();
  ...
  Manager.prototype.setHeading = function setHeading(angle) {
    var scene = this.ol3d.getCesiumScene();
  ...
  Manager.prototype.getOl3d = function getOl3d() {
    return this.ol3d;
  };
  ...
  Manager.prototype.getOlView = function getOlView() {
  ...
  Manager.prototype.getCesiumViewMatrix = function getCesiumViewMatrix() {
  ...
  Manager.prototype.getCesiumScene = function getCesiumScene() {
  ...
  Manager.prototype.flyToRectangle = function flyToRectangle(rectangle) {
    var _this6 = this;
  ...
  Manager.prototype.getCameraExtentRectangle = function getCameraExtentRectangle() {
    if (this.cameraExtentInRadians) {
